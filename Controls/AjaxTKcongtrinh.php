...
*/ 
    ...
    echo '<div class="right"><a target="_blank" href="Views/InTKCongTrinh.php?khoa='.$khoa.'&bm='.$bm.'&ncb='.$ncb.'">
    ...
    if($ncb!='n') $sql .= ' and KH_NamCongBo = "'.$ncb.'"';
     ...
     echo '<tr class="center bold" style="background:#99DDCC;"><td colspan="2">Tổng Cộng: '.$st.' Công Trình Nghiên Cứu Khoa Học.</td></tr>';
    }
