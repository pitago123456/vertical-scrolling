...
?>
<link rel="stylesheet" type="text/css" href="./Libraries/css/tknghiencuu.css" />
<script type="text/javascript" src="Libraries/js/tknghiencuu.js"></script>
<div id="main">
    <div id="big-box-input">
        <h3>Thống kê đề tài nghiên cứu khoa học</h3>
    ...
    document.getElementById('cbocdt').value,document.getElementById('get_nbd').value,document.getElementById('get_nkt').value)">Tạo thống kê</button>
