...
function Datepicker() {
	this._defaults = {
		...
		yearRange: 'c-90:c+90', // Range of years to show in drop-down: 'any' for direct text entry
	...
	this.regional = {
		'': { // US/English
			...
			prevStatus: 'Chọn tháng trước', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Show the previous year', // Status text for the previous year command
			nextText: 'Sau&gt;', // Text for the next month command
			nextStatus: 'Chọn tháng sau', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: 'Show the next year', // Status text for the next year command
			currentText: 'Current', // Text for the current month command
			currentStatus: 'Show the current month', // Status text for the current month command
			todayText: 'Hôm Nay', // Text for the today's month command
			todayStatus: 'Chọn ngày hôm nay', // Status text for the today's month command
			clearText: 'Clear', // Text for the clear command
			clearStatus: 'Clear all the dates', // Status text for the clear command
			closeText: 'Close', // Text for the close command
			closeStatus: 'Close the datepicker', // Status text for the close command
			yearStatus: 'Thay đổi năm', // Status text for year selection
			monthStatus: 'Thay đổi tháng', // Status text for month selection
